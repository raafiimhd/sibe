...
class _$InitialImpl implements _Initial {
  ...
  @override
  String toString() {
    return 'ProfileState(isLoading: $isLoading, hasError: $hasError, message: $message, profileModel: $profileModel)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoading, hasError, message, profileModel);
...
abstract class _Initial implements ProfileState {
  const factory _Initial(
      ...
      final String? message,
      final ProfileModel? profileModel}) = _$InitialImpl;
