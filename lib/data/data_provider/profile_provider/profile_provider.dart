...
@injectable
class ProfileProvider implements ProfileRepository {
  final Dio dio;
  final FlutterSecureStorage secureStorage;

  ProfileProvider(this.dio, this.secureStorage);
  @override
  Future<Either<ErrorMsg, ProfileModel>> profile() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return Left(
            ErrorMsg(message: ProfileModel.fromJson(response.data).message!));
      }
